...
internal static class Util
{
    ...
    public static (AttributeData? attr, int index) GetJsonConverterAttributeData(INamedTypeSymbol typeSymbol)
        => GetAttributeData(typeSymbol, Constants.NamespaceName, Constants.JsonConverterAttributeClassName);
